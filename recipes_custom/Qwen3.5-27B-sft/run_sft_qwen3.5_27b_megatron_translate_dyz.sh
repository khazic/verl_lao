...
TRAIN_FILES=${TRAIN_FILES:-"[/llm-align/liuchonghan/ins_dataset/ins_dataset/dayuzhong/lowest_metricx_train_selected.cleaned.messages.parquet,/llm-align/liuchonghan/ins_dataset/ins_dataset/dayuzhong/dayuzhong_instruct_gemini3.1_5w_messages.parquet]"}

MODEL_PATH=${MODEL_PATH:-/llm-align/liuchonghan/ckpt_verl/sft/verl_sft_qwen3_5_27b_megatron_translate_0330_dyz/qwen3_5_27b_megatron_translate_0325-megatron-tp4-pp1-cp1/global_step_3000/huggingface}
...
project_name=verl_sft_qwen3_5_27b_megatron_translate_0330_dyz
