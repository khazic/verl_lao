...
TRAIN_FILES=${TRAIN_FILES:-"[${PARQUET_DIR}/malay__to__burmese.parquet,${PARQUET_DIR}/malay__to__chinese.parquet,${PARQUET_DIR}/malay__to__english.parquet,${PARQUET_DIR}/malay__to__filipino.parquet,${PARQUET_DIR}/malay__to__indonesian.parquet,${PARQUET_DIR}/malay__to__khmer.parquet,${PARQUET_DIR}/malay__to__lao.parquet,${PARQUET_DIR}/malay__to__tamil.parquet,${PARQUET_DIR}/malay__to__thai.parquet,${PARQUET_DIR}/malay__to__vietnamese.parquet]"}

PROJECT_NAME=${PROJECT_NAME:-nips2026_qwen3_5_2b_base}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-malay_to_all_parquet_by_language}
