...
TRAIN_FILES=${TRAIN_FILES:-"[/llm-align/liuchonghan/ins_dataset/ins_dataset/tulu3_34999.parquet,${ALL_115700_DATASET},/llm-align/liuchonghan/verl_parquet_merged/tha_Thai_to_eng.parquet]"}

PROJECT_NAME=${PROJECT_NAME:-nips2026_qwen3_5_2b_base}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-ti_to_eng}
