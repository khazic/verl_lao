...
TRAIN_FILES=${TRAIN_FILES:-"[/llm-align/liuchonghan/ins_dataset/ins_dataset/tulu3_34999.parquet,${ALL_115700_DATASET}]"}

PROJECT_NAME=${PROJECT_NAME:-nips2026_qwen3_5_2b_sft_nolanguage_test}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-no_language}
